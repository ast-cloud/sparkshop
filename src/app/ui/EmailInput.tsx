...
export default function EmailInput(){
    ...
    return (
      <>
        <input type="email" placeholder="Your email" size={35} style={{borderTopLeftRadius:'8px', borderBottomLeftRadius:'8px', height:'45px', width:'100%', padding:'15px', outline:'none'}}/>
